classdef Port < handle
  ...
  methods
    ...
    function seq = RotateExpr(port, pExprX, pExprY, pExprZ, aExprX, ...
        aExprY, aExprZ)
      objName = 'Transform';
      obj = port.project.GetCOMObj(objName);
      seq = cstenv.CommandSequence(obj, objName);
    ...
    function seq = Rotate(port, pivotX, pivotY, pivotZ, angleX, angleY, ...
        angleZ, doUpdate)
      objName = 'Transform';
      obj = port.project.GetCOMObj(objName);
      seq = cstenv.CommandSequence(obj, objName);
    ...
    function seq = RotateAndCopyExpr(port, pExprX, pExprY, pExprZ, ...
    ...
    function seq = RotateAndCopy(port, pivotX, pivotY, pivotZ, angleX, ...
